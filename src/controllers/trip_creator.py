...
class TripCreator:
    ...
    def create(self, body) -> Dict:
        try:
            ...
            #O **body é o equivalente a tirar todos os elementos de um dicionário e colocamos em outro. No caso abaixo fizemos isso e adicionamos o id: trip_id
            ...
            send_email(
                [body["owner_email"]], 
                f"localhost:3000/trips/{trip_id}/confirm"
            )
